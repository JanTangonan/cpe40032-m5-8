    ...
    for x = 1, width do
        ...
        if x ~=1 and x~= lockBlockPosition and x ~= keyPosition and x < width - 3 and math.random(7) == 1    then
            ...
            ------------------------------------------------------------
                                ...
                                -- this is where the flag will appear
            if x >= width - 3 then
                goto continue
            end
            ------------------------------------------------------------            
...
------------------------------------------------------------
                                -- functions to make it organized
                ...
                if math.random(3) == 1 then
                    ...
                    local gem = GameObject {
                        ...
                        solid = false,
                                    ...
                                    -- gem added to the player's score
                        onConsume = function(player, object)
                            ...
                            player.score = player.score + 100
                                    ...
                                    -- make the gem appear from the block and play a sound
                    Timer.tween(0.1, {
...
function bushOnPillarMaker(x, y) 
    return GameObject {
        ...
        height = 16,
                            ...
                            -- random frame from bush_ids, and random row for variance
        frame = BUSH_IDS[math.random(#BUSH_IDS)] + (math.random(4) - 1) * 7
    }
end
